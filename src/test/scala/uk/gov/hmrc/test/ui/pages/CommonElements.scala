...
//    "No" -> By.id("countriesRentedPropertyYesOrNo-no"),
    ...
    "Zero-emission car allowance amount" -> By.id("zeroEmissionsCarAllowance"),
    ...
    "Replacement of domestic goods amount" -> By.id("costOfReplacingDomesticItems"),
    "Other capital allowances" -> By.cssSelector("<h1 class=\"govuk-heading-l\">Other capital allowances</h1>"),
    "Other capital allowances amount" -> By.id("otherCapitalAllowance"),
    ...
    "sba foreign qualifying amount" -> By.id("foreignStructureBuildingQualifyingAmount"),
    ...
    "sba foreign claim amount" -> By.id("foreignStructureBuildingAllowanceClaim"),
