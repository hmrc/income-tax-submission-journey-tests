...
class CommonStepDef extends BaseStepDef {
  ...
  Then( """^the user should see the correct (.*) url$""") { ( url: String) =>
    val expectedUrl: (String, String) = url match {
      ...
      case "Income Tax Account for individuals" => ("Income Tax Account", "http://localhost:9081/report-quarterly/income-and-expenses/view")
      case "Income Tax Account for agents" => ("Income Tax Account", "http://localhost:9081/report-quarterly/income-and-expenses/view/agents/income-tax-account")
