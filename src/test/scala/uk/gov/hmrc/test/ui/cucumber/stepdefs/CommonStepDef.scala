...
class CommonStepDef extends BaseStepDef {
  ...
  Then( """^the user should see the correct (.*) url$""") { ( url: String) =>
    val expectedUrl: (String, String) = url match {
      ...
      case "Income Tax Account individuals" => ("View tax calculation to date", "http://localhost:9081/report-quarterly/income-and-expenses/view")
      case "Income Tax Account agents" => ("View tax calculation to date", "http://localhost:9081/report-quarterly/income-and-expenses/view/agents/income-tax-account")
