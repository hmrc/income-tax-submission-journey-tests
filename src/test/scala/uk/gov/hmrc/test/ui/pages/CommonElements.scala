...
trait CommonElements extends BasePage with Matchers {
  ...
  val elements: Map[String, By] = Map(
    ...
    "Yes, premiums for a grant of lease" -> By.id("premiumsGrantLease"),
    "No, premiums for a grant of lease" -> By.id("premiumsGrantLease-no"),
    ...
    "Yes,consolidated expenses" -> By.id("consolidatedExpensesYesNo"),
    "No,consolidated expenses" -> By.id("consolidatedExpensesYesNo-no"),
