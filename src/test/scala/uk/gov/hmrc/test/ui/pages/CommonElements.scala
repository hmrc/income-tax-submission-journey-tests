...
trait CommonElements extends BasePage with Matchers{
  ...
  val elements: Map[String, By] = Map(
    ...
    "change expenses"                  -> By.cssSelector("#main-content > div > div > dl:nth-of-type(2)> div > dd.govuk-summary-list__actions > ul > li:nth-child(1) > a"),
    "view first employer"              -> By.cssSelector("#main-content > div > div > dl:nth-of-type(1) > div:nth-child(1) > dd > a"),
    "change employer"                  -> By.cssSelector("dl.govuk-summary-list:nth-child(4) > div:nth-child(1) > dd:nth-child(2) > ul:nth-child(1) > li:nth-child(1) > a:nth-child(1)"),
    ...
    "first change employment"          -> By.cssSelector("#main-content > div > div > dl:nth-of-type(1) > div:nth-child(1) > dd.govuk-summary-list__actions > ul > li:nth-child(1) > a"),
    "second change employment"         -> By.cssSelector("#main-content > div > div > dl:nth-of-type(1) > div:nth-child(2) > dd.govuk-summary-list__actions > ul > li:nth-child(1) > a"),
    "third change employment"          -> By.cssSelector("#main-content > div > div > dl:nth-of-type(1) > div:nth-child(3) > dd.govuk-summary-list__actions > ul > li:nth-child(1) > a"),
    ...
    "remove employment"                -> By.cssSelector("#main-content > div > div > dl:nth-of-type(1) > div > dd > ul > li:nth-child(2) > a"),
    "third remove employment"          -> By.cssSelector("#main-content > div > div > dl:nth-of-type(1) > div:nth-child(3) > dd.govuk-summary-list__actions > ul > li:nth-child(2) > a"),
    ...
    "second view" -> By.cssSelector("div.govuk-summary-list__row:nth-child(2) > div:nth-child(1) > dd:nth-child(3) > a:nth-child(1)"),
    ...
    "state benefit change amount" -> By.cssSelector("div.govuk-summary-list__row:nth-child(4) > dd:nth-child(3) > a:nth-child(1) > span:nth-child(1)"),
