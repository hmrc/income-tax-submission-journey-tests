...
//    "No" -> By.id("countriesRentedPropertyYesOrNo-no"),
  ...
  "How much total rent a room income did your client receive?" -> By.cssSelector("#main-content > div > div > h1"),
    ...
    "Travel and accommodation for work" -> By.xpath("//dt[@class='govuk-summary-list__key']//a[substring(@href, string-length(@href) - string-length('expenses/travel-accommodation/vehicles') + 1) = 'expenses/travel-accommodation/vehicles']"),
