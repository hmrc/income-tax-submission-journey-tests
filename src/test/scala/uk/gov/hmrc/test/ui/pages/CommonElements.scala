...
trait CommonElements extends BasePage with Matchers {
  ...
  private[pages] val commonMapping: List[(String, By)] = List(
    ...
    "Day" -> By.id("foreignStructureBuildingQualifyingDate.day"),
    "Month" -> By.id("foreignStructureBuildingQualifyingDate.month"),
    "Year" -> By.id("foreignStructureBuildingQualifyingDate.year"),
