...
trait CommonElements extends BasePage with Matchers{
  ...
  val elements: Map[String, By] = Map(
    ...
    "Pay"                             -> By.id("amount"),
    "Tax"                             -> By.id("amount"),
    "1st change"                      -> By.cssSelector("#main-content > div > div > div:nth-child(3) > ul > li:nth-child(1) > span.hmrc-add-to-a-list__change > a"),
    ...
    "change paye reference"           -> By.cssSelector("#main-content > div > div > dl > div:nth-child(3) > dd.govuk-summary-list__actions.govuk-\\!-width-one-third > a"),
    "change pay received"             -> By.cssSelector("#main-content > div > div > dl > div:nth-child(4) > dd.govuk-summary-list__actions.govuk-\\!-width-one-third > a"),
    "change tax taken from pay"       -> By.cssSelector("#main-content > div > div > dl > div:nth-child(5) > dd.govuk-summary-list__actions.govuk-\\!-width-one-third > a"),
    "third remove"                    -> By.cssSelector("#main-content > div > div > div:nth-child(3) > ul > li:nth-child(3) > span.hmrc-add-to-a-list__remove > a"),
