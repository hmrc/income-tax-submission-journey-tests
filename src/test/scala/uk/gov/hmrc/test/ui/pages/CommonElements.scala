...
trait CommonElements extends BasePage with Matchers {
  ...
  private[pages] val commonMapping: List[(String, By)] = List(
    ...
    "HYFTS AboutPropertyYes" -> By.id("aboutPropertyRentalsSectionFinishedYesOrNo"),
    "HYFTS AboutPropertyNo" -> By.id("aboutPropertyRentalsSectionFinishedYesOrNo-no"),
    "HYFTS,Yes" -> By.id("aboutPropertyCompleteYesOrNo"),
    "HYFTS,No" -> By.id("aboutPropertyCompleteYesOrNo-no"),
    "Yes HYFTS" -> By.id("aboutPropertyRentalsSectionFinishedYesOrNo"),
    "No HYFTS" -> By.id("aboutPropertyRentalsSectionFinishedYesOrNo-no"),
    "IncomeYes,HYFTS" -> By.id("incomeSectionFinishedYesOrNo"),
    "IncomeNo,HYFTS" -> By.id("incomeSectionFinishedYesOrNo-no"),
    "AdjustmentsYes,HYFTS" -> By.id("rentalsAdjustmentsCompleteYesOrNo"),
    "AdjustmentsNo,HYFTS" -> By.id("rentalsAdjustmentsCompleteYesOrNo-no"),
    "ExpensesYes,HYFTS" -> By.id("expensesSectionFinishedYesOrNo"),
    "ExpensesNo,HYFTS" -> By.id("expensesSectionFinishedYesOrNo-no"),
    "AllowancesYes,HYFTS" -> By.id("allowancesSectionFinishedYesOrNo"),
    "AllowancesNo,HYFTS" -> By.id("allowancesSectionFinishedYesOrNo-no"),
    "sbaYes,HYFTS" -> By.id("sbaSectionFinishedYesOrNo"),
    "sbaNo,HYFTS" -> By.id("sbaSectionFinishedYesOrNo-no"),
    "esbaYes,HYFTS" -> By.id("esbaSectionFinishedYesOrNo"),
    "esbaNo,HYFTS" -> By.id("esbaSectionFinishedYesOrNo-no"),
    ...
    "Yes, claim property income allowance" -> By.id("claimPropertyIncomeAllowanceYesOrNo"),
    "No, claim expenses" -> By.id("claimPropertyIncomeAllowanceYesOrNo-no"),
    "Check Your Answers"-> By.cssSelector("#main-content > div > div > h1"),
    ...
    "Income" -> By.cssSelector("#main-content > div > div > ol:nth-child(5) > li:nth-child(2) > div.govuk-task-list__name-and-hint > a"),
    ...
    "Yes, premiums for a grant of lease" -> By.id("premiumForLeaseYesOrNo"),
    "No, premiums for a grant of lease" -> By.id("premiumForLeaseYesOrNo-no"),
    ...
    "Check Your Answers" -> By.cssSelector("#main-content > div > div > h1"),
    "AdjustmentsLink" -> By.cssSelector("#main-content > div > div > ol:nth-child(5) > li:nth-child(3) > div.govuk-task-list__name-and-hint > a"),
    ...
    "BalancingChargeYes" -> By.id("balancingChargeYesNo"),
    "BalancingChargeNo" -> By.id("balancingChargeYesNo-no"),
    ...
    "Yes, did you have any unused losses for your property rental in previous years?" -> By.id("unusedLossesBroughtForwardYesOrNo"),
    ...
    "Check Your Answers" -> By.cssSelector("#main-content > div > div > h1"),
    "ExpensesLink" -> By.cssSelector("#main-content > div > div > ol:nth-child(5) > li:nth-child(3) > div.govuk-task-list__name-and-hint > a"),//By.id("expenses_link"),
    ...
    "Yes,consolidated expenses" -> By.id("consolidatedExpensesYesOrNo"),
    "No,consolidated expenses" -> By.id("consolidatedExpensesYesOrNo-no"),
    ...
    "Allowanceslink" -> By.cssSelector("#main-content > div > div > ol:nth-child(5) > li:nth-child(4) > div.govuk-task-list__name-and-hint > a"),//By.id("allowances_link"),
    "Allowances" -> By.cssSelector("#main-content > div > div > h1"),
    "Capital allowances for a car" -> By.cssSelector("#main-content > div > div > h1"),
    "Yes,capital allowances for a car" -> By.id("capitalAllowancesForACarYesNo"),
    "No,capital allowances for a car" -> By.id("capitalAllowancesForACarYesNo-no"),
    ...
    "Structures and Buildings AllowanceLink" -> By.cssSelector("#main-content > div > div > ol:nth-child(5) > li:nth-child(5) > div.govuk-task-list__name-and-hint > a"),
    ...
    "Enhanced Structures and Buildings AllowanceLink" -> By.cssSelector("#main-content > div > div > ol:nth-child(5) > li:nth-child(6) > div.govuk-task-list__name-and-hint > a"),
