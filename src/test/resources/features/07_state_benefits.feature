...
#--@sberror
   #----------Error messages JSA/ESA - Dates - Days values -------------------
  Scenario: Individual User invalid date value entered for Jobseekers allowance - EOY
    When the user logs into the service with the following details
      | Redirect url        | /EOY/start  |
      | Credential Strength | strong      |
      | Confidence Level    | 250         |
    ...
    When the user clicks the Add missing claim button
    Then the user should be redirected to the "When did you start getting Jobseeker’s Allowance?" page
    When the user selects the claim day field and enters a value of w
    And the user selects the claim month field and enters a value of 01
    And the user selects the claim year field and enters a value of 2023
    And the user clicks the continue button
    And the The date you started getting Jobseeker’s Allowance must include a day is displayed


#----------Error messages JSA/ESA - Dates - Month values -------------------
  #--@sberror
  Scenario: Individual User invalid month value entered for Jobseekers allowance - EOY
    When the user logs into the service with the following details
      | Redirect url        | /EOY/start  |
      | Credential Strength | strong      |
      | Confidence Level    | 250         |
    ...
    Then the user should be redirected to the "When did you start getting Jobseeker’s Allowance?" page
    When the user selects the claim day field and enters a value of 01
    And the user selects the claim month field and enters a value of fg
    And the user selects the claim year field and enters a value of 2023
    And the user clicks the continue button
    And the The date you started getting Jobseeker’s Allowance must include a month is displayed


    #----------Error messages JSA/ESA - Dates - Year value -------------------
  #--@sberror
  Scenario: Individual User invalid month value entered for Jobseekers allowance - EOY
    When the user logs into the service with the following details
      | Redirect url        | /EOY/start  |
    ...
    When the user selects the claim day field and enters a value of 01
    And the user selects the claim month field and enters a value of 01
    And the user selects the claim year field and enters a value of yu
    And the user clicks the continue button
    And the The date you started getting Jobseeker’s Allowance must include a year is displayed
