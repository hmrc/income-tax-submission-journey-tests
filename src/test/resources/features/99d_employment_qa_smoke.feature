...
Feature: Smoke downstream Employment Journeys to DES in QA - Income Tax Submission

  Background:
    Given the user navigates to the auth login page

  Scenario: Returning flow - Individual User with prior UK employment views their details and benefits - Employment Smoke
  ...
  Scenario: Returning flow - Agent User with prior UK employment views their details and benefits - Employment Smoke
    When the user logs into the service with the following details
      |Redirect url       |/test-only/2022/additional-parameters?ClientNino=PW213533A&ClientMTDID=9876543211  |
