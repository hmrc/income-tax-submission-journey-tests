...
trait CommonElements extends BasePage with Matchers {
  ...
  private[pages] val commonMapping: List[(String, By)] = List(
    ...
    "UK property About" -> By.cssSelector("#main-content > div > div > ol > li > div.govuk-task-list__name-and-hint > a"),//By.id("property_about_link"),
    ...
    "Property rentals about" -> By.cssSelector("#main-content > div > div > ol:nth-child(5) > li > div.govuk-task-list__name-and-hint > a"),
