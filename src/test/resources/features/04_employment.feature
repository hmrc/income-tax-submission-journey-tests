...
#    TODO: remove "then the user navigates to check employment expenses page" after content iterations for employment summary page
    Then the user navigates to the check employment expenses page
