...
trait CommonElements extends BasePage with Matchers {
  ...
  private[pages] val commonMapping: List[(String, By)] = List(
    ...
    "Donations using Gift Aid task list"                  -> By.className("DonationsUsingGiftAid"),
    "Gifts of land or property task list"                 -> By.className("GiftsOfLandOrProperty"),
    "Gifts of shares or securities task list"             -> By.className("GiftsOfShares"),
    "Gifts of overseas charities task list"               -> By.className("GiftsToOverseasCharities"),
    "PAYE employment (including student loans) task list" -> By.className("PayeEmployment"),
    "Construction Industry Schemes deductions"            -> By.className("CIS"),
    "Review Employment and support allowance claims"      -> By.className("ESA"),
    "Review Jobseeker’s Allowance claims"                 -> By.className("JSA"),
    "State Pension1"                                      -> By.className("StatePension"),
    "Other UK Pensions1"                                  -> By.className("OtherUkPensions"),
    "Unauthorised payments1"                              -> By.className("UnauthorisedPayments"),
    "Short service refunds1"                              -> By.className("ShortServiceRefunds"),
    "Income from overseas pensions1"                      -> By.className("IncomeFromOverseas"),
    "Payments into UK pensions1"                          -> By.className("PaymentsIntoUk"),
    "Annual allowances1"                                  -> By.className("AnnualAllowances"),
    "Payments into overseas pensions"                     -> By.className("PaymentsIntoOverseas"),
    "Overseas transfer charge1"                           -> By.className("OverseasTransfer"),
    "Banks and building societies task list"                       -> By.className("BanksAndBuilding"),
    "Trust fund bond or bonds task list"                            -> By.className("TrustFundBond"),
    "Gilt-edged or accrued income securities task list"            -> By.className("GiltEdged"),
    "Cash dividends from UK stocks and shares task list"           -> By.className("CashDividends"),
    "Stock dividends from UK companies task list"                  -> By.className("StockDividends"),
    "Dividends from unit trusts or investment companies task list" -> By.className("DividendsFromUnitTrusts"),
    "Free or redeemable shares task list"                          -> By.className("FreeRedeemableShares"),
    "Close company loans written off or released task list"        -> By.className("CloseCompanyLoans"),
    "Life Insurance common task list"                     -> By.className("LifeInsurance"),
    ...
    "Review self-employments" -> By.cssSelector("#main-content > div > div > div.task-list > dl:nth-child(3) > div:nth-child(1) > dt > span > a"),
    ...
    "Self-employment Expenses categories" -> By.cssSelector("#main-content > div > div > div.task-list > dl:nth-child(3) > div:nth-child(4) > dt > span > a"),
