...
trait CommonElements extends BasePage with Matchers {
  ...
  private[pages] val commonMapping: List[(String, By)] = List(
    ...
    "Check Your Answers continue" -> By.id("continue"),//By.cssSelector("#main-content > div > div > a"),
    ...
    "Change" -> By.cssSelector("#main-content > div > div > form > dl > div:nth-child(2) > dd.govuk-summary-list__actions > a"),
    ...
    "Allowanceslink" -> By.id("allowances_link"),
    ...
    "Structures and Buildings AllowanceLink" -> By.cssSelector("#structuresAndBuildingAllowance_link"),
    "Do you want to claim structures and buildings allowance?" -> By.cssSelector("#main-content > div > div > form > div > fieldset > legend"),
    ...
    "Qualifying amount" -> By.cssSelector("#main-content > div > div > form > h1"),
