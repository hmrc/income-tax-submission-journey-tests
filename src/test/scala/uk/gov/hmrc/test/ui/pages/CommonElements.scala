...
trait CommonElements extends BasePage with Matchers {
  ...
  private[pages] val commonMapping: List[(String, By)] = List(
    ...
    "Did you have any unused losses for your property rental in previous years?" -> By.cssSelector("#main-content > div > div > form > h1"),
    ...
    "Check Your Answers" -> By.cssSelector("#main-content > div > div > h1"),
    "Rents, rates and insurance costs for your property" -> By.cssSelector("#main-content > div > div > form > h1"),
    ...
    "Capital allowances for a car" -> By.cssSelector("#main-content > div > div > h1"),
